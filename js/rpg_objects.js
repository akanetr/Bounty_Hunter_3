...
//変更追加　興奮　歩数加算
    if ($gameVariables.value(37)>=61) {

        $gameVariables.setValue(635,$gameVariables.value(635)+1);
        if ($gameVariables.value(37)>=61 && $gameVariables.value(37)<=70) {

           if ($gameVariables.value(635)>=240) {

              $gameSwitches.setValue(252,true);
           }
        } else if ($gameVariables.value(37)>=71 && $gameVariables.value(37)<=99) {

           if ($gameVariables.value(635)>=150) {

              $gameSwitches.setValue(252,true);
           }
        } else if ($gameVariables.value(37)==100) {
           if ($gameVariables.value(635)>=70) {
...
//変更追加　もよおし　歩数加算
    if ($gameVariables.value(36)>=50) {

        $gameVariables.setValue(636,$gameVariables.value(636)+1);
        if ($gameVariables.value(36)>=50 && $gameVariables.value(36)<=99) {

           if ($gameVariables.value(636)>=100) {

              $gameSwitches.setValue(253,true);
           }
        } else if ($gameVariables.value(36)==100) {
           if ($gameVariables.value(636)>=50) {
...
Game_CharacterBase.prototype.distancePerFrame = function() {
    ...
    return Math.pow(2, this.realMoveSpeed()) / 282;
