...
Scene_Save.prototype.initialize = function() {
    ...
    //変更 セーブ情報
    $gameVariables.setValue(359,$dataMap.displayName);
    $gameVariables.setValue(360,$gameParty.gold());
    //変更 上段ヘルプ幅
    $gameSwitches.setValue(18,false);
...
Scene_Shop.prototype.createGoldWindow = function() {
    ...
    this._goldWindow.x = 576;  //Graphics.boxWidth - this._goldWindow.width;
...
Scene_Shop.prototype.createDummyWindow = function() {
    ...
    this._dummyWindow = new Window_Base(0, wy, Graphics.boxWidth-304, wh);
