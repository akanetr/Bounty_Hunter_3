...
(function() {
    ...
    var footStepJson = {
        ...
        always     : {
            interval: 1,
            walk1   : {name: '歩き1', volume: 50, pitch: 100, pan: 0},
            walk2   : {name: '', volume: 90, pitch: 100, pan: 0},
            dash1   : {name: '歩き1', volume: 50, pitch: 100, pan: 0},
        ...
        bush       : {
            interval: 1,
            walk1   : {name: '歩き2', volume: 50, pitch: 100, pan: 0},
            walk2   : {name: '', volume: 90, pitch: 100, pan: 0},
            dash1   : {name: '歩き2', volume: 50, pitch: 100, pan: 0},
            dash2   : {name: '', volume: 90, pitch: 100, pan: 0},
        },
        // ダメージ床属性通過時の足音
        damageFloor: {
