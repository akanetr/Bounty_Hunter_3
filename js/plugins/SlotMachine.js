 ...
 * @requiredAssets audio/me/ooatari
...
SLTReelSprite.FRAME_SPINNING = 20;

//SLTReelSprite.FRAME_SPIN = 60;

SLTReelSprite.FRAME_SPIN = 30;

//SLTReelSprite.FRAME_STOPPING = 40;

SLTReelSprite.FRAME_STOPPING = 20;
...
Scene_SlotMachine.prototype.initialize = function () {
    ...
    this._probability[0].push(0.70);
 //00

    this._probability[0].push(0.63);
 //11

    this._probability[0].push(0.54);
 //22

    this._probability[0].push(0.44);
 //33

    this._probability[0].push(0.38);
 //44

    this._probability[0].push(0.31);
 //55
...
Scene_SlotMachine.prototype.create = function () {
    ...
    if (!$gameSwitches.value(48)) {
        ...
        this._backgroundSprite.bitmap = ImageManager.loadBitmap("img/slotmachine/", "bg2");
...
Scene_SlotMachine.prototype.createSlotCommand = function () {
    ...
    //変更追加
    this._slotCommandWindow.width = 816;
...
Scene_SlotMachine.prototype.createReplayCommand = function () {
    ...
    //変更追加
    this._replayCommandWindow.width = 130;
    ...
    this._replayCommandWindow.x = 820;
    //this._replayCommandWindow.y = this._helpWindow.y - this._replayCommandWindow.height;

    this._replayCommandWindow.y = Graphics.boxHeight - this._helpWindow.height;
...
Scene_SlotMachine.prototype.result = function () {
    ...
    if (this._winCoin > 0) {
        ...
        //当たり時の効果音
        AudioManager.playMe({"name": "ooatari", "volume": 40, "pitch": 150, "pan": 0});
