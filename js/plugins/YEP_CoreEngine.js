...
Window_Base.prototype.drawActorLevel = function(actor, x, y) {
    ...
    if ($gameSwitches.value(115)) {
       this.drawText("気分", x, y);
    } else {
       this.drawText("Mo", x, y);
    }
    this.resetTextColor();

    //日本語
    if ($gameSwitches.value(115)) {
        if ($gameVariables.value(37) >= 0 && $gameVariables.value(37) <= 40) {
           this.drawText("平常", x+10 + dw1, y, 'right');
        } else if ($gameVariables.value(37) >= 41 && $gameVariables.value(37) <= 60) {
           this.drawText("むらむら", x+10 + dw1, y, 'right');
        } else if ($gameVariables.value(37) >= 61 && $gameVariables.value(37) <= 99) {
           this.drawText("発情気味", x+10 + dw1, y, 'right');
        } else {
           this.drawText("淫乱気味", x+10 + dw1, y, 'right');
        }
    } else {
        if ($gameVariables.value(37) >= 0 && $gameVariables.value(37) <= 40) {
           this.drawText("Normal", x+10 + dw1, y, 'right');
        } else if ($gameVariables.value(37) >= 41 && $gameVariables.value(37) <= 60) {
           this.drawText("Slight fever", x+10 + dw1, y, 'right');
        } else if ($gameVariables.value(37) >= 61 && $gameVariables.value(37) <= 99) {
           this.drawText("Estrus", x+10 + dw1, y, 'right');
        } else {
           this.drawText("Nasty", x+10 + dw1, y, 'right');
        }
    }
...
Window_Base.prototype.drawActorTp = function(actor, x, y, width) {
    ...
    this.drawGauge(x, y, width, ($gameVariables.value(36) / 100), color1, color2);
    //this.drawGauge(x, y, width, actor.tpRate(), color1, color2);
    this.changeTextColor(this.systemColor());
    //日本語
    if ($gameSwitches.value(115)) {
       this.drawText("ﾄｲﾚ", x, y, 44);
    } else {
       this.drawText("toilet", x, y, 44);
    }
    this.changeTextColor(this.tpColor(actor));
    //this.drawText(Yanfly.Util.toGroup(actor.tp), x + width - 64, y, 64, 'right');
    this.drawText(Yanfly.Util.toGroup($gameVariables.value(36)), x + width - 64, y, 64, 'right');
};


//変更-------------------------------------------------------------
Window_Base.prototype.drawActorbb = function(actor, x, y, width) {
    width = width || 187;
    var color1 = this.tpGaugeColor1();
    var color2 = this.tpGaugeColor2();
    this.drawGauge(x, y, width, ($gameVariables.value(35) / 100), color1, color2);
    this.changeTextColor(this.systemColor());
    //日本語
    if ($gameSwitches.value(115)) {
       this.drawText("酔い", x, y, 44);
    } else {
       this.drawText("Drunkenness", x, y, 44);
    }
    this.changeTextColor(this.tpColor(actor));
    this.drawText($gameVariables.value(35), x + width - 65, y, 64, 'right');
};
...
Window_Base.prototype.drawActorSimpleStatus = function(actor, x, y, width) {
    ...
    this.drawActorHp(actor, x2, (y + lineHeight * 1)-8 * 1, width2);

    //変更　ラーダの場合非表示
    if (!$gameSwitches.value(160)) {
        this.drawActorMp(actor, x2, (y + lineHeight * 2)-13, width2);
        if (eval(Yanfly.Param.MenuTpGauge)) {
          this.drawActorTp(actor, x2, (y + lineHeight * 3)-19, width2);
          this.drawActorbb(actor, x2, (y + lineHeight * 4)-24, width2);
        }
    }
...
Window_Status.prototype.drawParameters = function(x, y) {
    ...
    if (!$gameSwitches.value(160)) {
        ...
        if ($gameSwitches.value(115)) {
            ...
            this.drawText("セックス回数", x, (y-12) + lineHeight * 0, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(333), x + 180, (y-12) + lineHeight * 0, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("人", x + 250, (y-12) + lineHeight * 0, 0);

            this.changeTextColor(this.systemColor());
            this.drawText("犯され・凌辱回数", x, (y-12) + lineHeight * 1, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(345), x + 180, (y-12) + lineHeight * 1, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("回", x + 250, (y-12) + lineHeight * 1, 0);

            this.changeTextColor(this.systemColor());
            this.drawText("フェラチオ回数", x, (y-12) + lineHeight * 2, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(334), x + 180, (y-12) + lineHeight * 2, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("回", x + 250, (y-12) + lineHeight * 2, 0);

            this.changeTextColor(this.systemColor());
            this.drawText("手コキ回数", x, (y-12) + lineHeight * 3, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(335), x + 180, (y-12) + lineHeight * 3, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("回", x + 250, (y-12) + lineHeight * 3, 0);

            this.changeTextColor(this.systemColor());
            this.drawText("レズ回数", x, (y-12) + lineHeight * 4, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(336), x + 180, (y-12) + lineHeight * 4, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("回", x + 250, (y-12) + lineHeight * 4, 0);

            this.changeTextColor(this.systemColor());
            this.drawText("オナニー回数", x, (y-12) + lineHeight * 5, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(337), x + 180, (y-12) + lineHeight * 5, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("回", x + 250, (y-12) + lineHeight * 5, 0);

            this.changeTextColor(this.systemColor());
            this.drawText("放尿回数", x, (y-12) + lineHeight * 6, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(338), x + 180, (y-12) + lineHeight * 6, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("回", x + 250, (y-12) + lineHeight * 6, 0);

        } else {

            this.changeTextColor(this.systemColor());

            this.drawText("Sex Count", x, (y-12) + lineHeight * 0, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(333), x + 180, (y-12) + lineHeight * 0, 60, 'right');

            this.changeTextColor(this.systemColor());
            this.drawText("Rape/Insult Count", x, (y-12) + lineHeight * 1, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(345), x + 180, (y-12) + lineHeight * 1, 60, 'right');

            this.changeTextColor(this.systemColor());
            this.drawText("Blowjob Count", x, (y-12) + lineHeight * 2, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(334), x + 180, (y-12) + lineHeight * 2, 60, 'right');

            this.changeTextColor(this.systemColor());
            this.drawText("Handjob Count", x, (y-12) + lineHeight * 3, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(335), x + 180, (y-12) + lineHeight * 3, 60, 'right');

            this.changeTextColor(this.systemColor());
            this.drawText("Lesbian Count", x, (y-12) + lineHeight * 4, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(336), x + 180, (y-12) + lineHeight * 4, 60, 'right');

            this.changeTextColor(this.systemColor());
            this.drawText("Masturbation Count", x, (y-12) + lineHeight * 5, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(337), x + 180, (y-12) + lineHeight * 5, 60, 'right');

            this.changeTextColor(this.systemColor());
            this.drawText("Urination Count", x, (y-12) + lineHeight * 6, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(338), x + 180, (y-12) + lineHeight * 6, 60, 'right');
    ...
    //ラーダの場合-------------------------------------------------------------
        ...
        if ($gameSwitches.value(115)) {
            ...
            this.changeTextColor(this.systemColor());
            this.drawText("セフレ人数", x, y + lineHeight * 0, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(339), x + 180, y + lineHeight * 0, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("人", x + 250, y + lineHeight * 0, 0);

            this.changeTextColor(this.systemColor());
            this.drawText("総セックス回数", x, y + lineHeight * 1, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(340), x + 180, y + lineHeight * 1, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("回", x + 250, y + lineHeight * 1, 0);

            this.changeTextColor(this.systemColor());
            this.drawText("フェラ射精回数", x, y + lineHeight * 2, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(341), x + 180, y + lineHeight * 2, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("回", x + 250, y + lineHeight * 2, 0);

            this.changeTextColor(this.systemColor());
            this.drawText("膣内射精回数", x, y + lineHeight * 3, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(342), x + 180, y + lineHeight * 3, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("回", x + 250, y + lineHeight * 3, 0);

            this.changeTextColor(this.systemColor());
            this.drawText("膣外射精回数", x, y + lineHeight * 4, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(343), x + 180, y + lineHeight * 4, 60, 'right');
            this.changeTextColor(this.systemColor());
            this.drawText("回", x + 250, y + lineHeight * 4, 0);

        } else {

            this.changeTextColor(this.systemColor());
            this.drawText("Sex friends", x, y + lineHeight * 0, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(339), x + 180, y + lineHeight * 0, 60, 'right');

            this.changeTextColor(this.systemColor());
            this.drawText("Total sex", x, y + lineHeight * 1, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(340), x + 180, y + lineHeight * 1, 60, 'right');

            this.changeTextColor(this.systemColor());
            this.drawText("Fellatio ejaculation", x, y + lineHeight * 2, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(341), x + 180, y + lineHeight * 2, 60, 'right');

            this.changeTextColor(this.systemColor());
            this.drawText("Vaginal ejaculation", x, y + lineHeight * 3, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(342), x + 180, y + lineHeight * 3, 60, 'right');

            this.changeTextColor(this.systemColor());
            this.drawText("Extravaginal ejaculation", x, y + lineHeight * 4, 160);
            this.resetTextColor();
            this.drawText($gameVariables.value(343), x + 180, y + lineHeight * 4, 60, 'right');
...
Window_Status.prototype.drawExpInfo = function(x, y) {
    ...
    if ($gameSwitches.value(115)) {
       var zyoutai = "フリー";
       if ($gameVariables.value(346)==1) {
          zyoutai = "メイド喫茶店員";
       } else if ($gameVariables.value(346)==11) {
          zyoutai = "メイド喫茶バイト申し込み中";
       } else if ($gameVariables.value(346)==2) {
          zyoutai = "ピンサロ店員";
       } else if ($gameVariables.value(346)==22) {
          zyoutai = "ピンサロバイト申し込み中";
       } else if ($gameVariables.value(346)==3) {
          zyoutai = "ナース";
       } else if ($gameVariables.value(346)==33) {
          zyoutai = "ナースバイト申し込み中";
       } else if ($gameVariables.value(346)==4) {
          zyoutai = "カジノ店員";
       } else if ($gameVariables.value(346)==44) {
          zyoutai = "カジノバイト申し込み中";
       }
       var keika1 = "日経過";
       var kyuyo1 = " 給料日";
       var heiten1 = " 閉店中";
       var tenpoQ1 = "2地区宿屋ｵｰﾅｰ:";
       var tenpoQ2 = "2地区飲み屋ｵｰﾅｰ:";
       var tenpoQ3 = "3地区雑貨屋ｵｰﾅｰ:";
       var tenpoQ4 = "5地区めし屋ｵｰﾅｰ:";
       var tenpoQ5 = "9地区射撃場ｵｰﾅｰ:";
       var tenpoQ6 = "9地区スナックｵｰﾅｰ:";
    } else {
       var zyoutai = "free";
       if ($gameVariables.value(346)==1) {
          zyoutai = "Maid cafe staff";
       } else if ($gameVariables.value(346)==2) {
          zyoutai = "Pink salon clerk";
       } else if ($gameVariables.value(346)==3) {
          zyoutai = "nurse";
       }
       var keika1 = " days";
       var kyuyo1 = "Payday";
       var heiten1 = "Closed";
       var tenpoQ1 = "2 distric inn Ow:";
       var tenpoQ2 = "2 distric bar Ow:";
       var tenpoQ3 = "3 distric Store Ow:";
       var tenpoQ4 = "5 distric diner Ow:";
       var tenpoQ5 = "9 distric shoot Ow:";
       var tenpoQ6 = "9 distric bar Ow:";
    }

    //---------------------------------------------------
    if($gameParty.hasItem($dataItems[65])){
        tenpo1 = tenpoQ1;
      if($gameVariables.value(181) <= 9){
         tenpo1z =$gameVariables.value(181) + keika1;
      }
      if($gameVariables.value(181) == 10){
         tenpo1z = kyuyo1;
      }
      if($gameVariables.value(181) >= 11){
         tenpo1z = heiten1;
      }
    }
    if($gameParty.hasItem($dataItems[66])){
      if(tenpo1 == "---"){
         tenpo1 = tenpoQ2;
         if($gameVariables.value(182) <= 9){
            tenpo1z =$gameVariables.value(182) + keika1;
         }
         if($gameVariables.value(182) == 10){
            tenpo1z = kyuyo1;
         }
         ...
         tenpo2 = tenpoQ2;
         if($gameVariables.value(182) <= 9){
            tenpo2z =$gameVariables.value(182) + keika1;
         }
         if($gameVariables.value(182) == 10){
            tenpo2z = kyuyo1;
         }
    ...
    if($gameParty.hasItem($dataItems[67])){
      if(tenpo1 == "---"){
         tenpo1 = tenpoQ3;
         if($gameVariables.value(183) <= 9){
            tenpo1z =$gameVariables.value(183) + keika1;
         }
         if($gameVariables.value(183) == 10){
            tenpo1z = kyuyo1;
         }
         if($gameVariables.value(183) >= 11){
            tenpo1z = heiten1;
         }
      } else {
         if(tenpo2 == "---"){
            tenpo2 = tenpoQ3;
            if($gameVariables.value(183) <= 9){
               tenpo2z =$gameVariables.value(183) + keika1;
            }
            if($gameVariables.value(183) == 10){
               tenpo2z = kyuyo1;
            }
            ...
            tenpo3 = tenpoQ3;
            if($gameVariables.value(183) <= 9){
               tenpo3z =$gameVariables.value(183) + keika1;
            }
            if($gameVariables.value(183) == 10){
               tenpo3z = kyuyo1;
            }
    ...
    if($gameParty.hasItem($dataItems[68])){
      if(tenpo1 == "---"){
         tenpo1 = tenpoQ4;
         if($gameVariables.value(184) <= 9){
            tenpo1z =$gameVariables.value(184) + keika1;
         }
         if($gameVariables.value(184) == 10){
            tenpo1z = kyuyo1;
         }
         if($gameVariables.value(184) >= 11){
            tenpo1z = heiten1;
         }
      } else {
         if(tenpo2 == "---"){
            tenpo2 = tenpoQ4;
            if($gameVariables.value(184) <= 9){
               tenpo2z =$gameVariables.value(184) + keika1;
            }
            if($gameVariables.value(184) == 10){
               tenpo2z = kyuyo1;
            }
            ...
            if(tenpo3 == "---"){
               tenpo3 = tenpoQ4;
               if($gameVariables.value(184) <= 9){
                  tenpo3z =$gameVariables.value(184) + keika1;
               }
               if($gameVariables.value(184) == 10){
                  tenpo3z = kyuyo1;
               }
               ...
               tenpo4 = tenpoQ4;
               if($gameVariables.value(184) <= 9){
                  tenpo4z =$gameVariables.value(184) + keika1;
               }
               if($gameVariables.value(184) == 10){
                  tenpo4z = kyuyo1;
               }
    ...
    if($gameParty.hasItem($dataItems[69])){
      if(tenpo1 == "---"){
         tenpo1 = tenpoQ5;
         if($gameVariables.value(185) <= 9){
            tenpo1z =$gameVariables.value(185) + keika1;
         }
         if($gameVariables.value(185) == 10){
            tenpo1z = kyuyo1;
         }
         if($gameVariables.value(185) >= 11){
            tenpo1z = heiten1;
         }
      } else {
         if(tenpo2 == "---"){
            tenpo2 = tenpoQ5;
            if($gameVariables.value(185) <= 9){
               tenpo2z =$gameVariables.value(185) + keika1;
            }
            if($gameVariables.value(185) == 10){
               tenpo2z = kyuyo1;
            }
            ...
            if(tenpo3 == "---"){
               tenpo3 = tenpoQ5;
               if($gameVariables.value(185) <= 9){
                  tenpo3z =$gameVariables.value(185) + keika1;
               }
               if($gameVariables.value(185) == 10){
                  tenpo3z = kyuyo1;
               }
               ...
               if(tenpo4 == "---"){
                  tenpo4 = tenpoQ5;
                  if($gameVariables.value(185) <= 9){
                     tenpo4z =$gameVariables.value(185) + keika1;
                  }
                  if($gameVariables.value(185) == 10){
                     tenpo4z = kyuyo1;
                  }
                  ...
                  tenpo5 = tenpoQ5;
                  if($gameVariables.value(185) <= 9){
                     tenpo5z =$gameVariables.value(185) + keika1;
                  }
                  if($gameVariables.value(185) == 10){
                     tenpo5z = kyuyo1;
                  }
    ...
    if($gameParty.hasItem($dataItems[70])){
      if(tenpo1 == "---"){
         tenpo1 = tenpoQ6;
         if($gameVariables.value(186) <= 9){
            tenpo1z =$gameVariables.value(186) + keika1;
         }
         if($gameVariables.value(186) == 10){
            tenpo1z = kyuyo1;
         }
         if($gameVariables.value(186) >= 11){
            tenpo1z = heiten1;
         }
      } else {
         if(tenpo2 == "---"){
            tenpo2 = tenpoQ6;
            if($gameVariables.value(186) <= 9){
               tenpo2z =$gameVariables.value(186) + keika1;
            }
            if($gameVariables.value(186) == 10){
               tenpo2z = kyuyo1;
            }
            ...
            if(tenpo3 == "---"){
               tenpo3 = tenpoQ6;
               if($gameVariables.value(186) <= 9){
                  tenpo3z =$gameVariables.value(186) + keika1;
               }
               if($gameVariables.value(186) == 10){
                  tenpo3z = kyuyo1;
               }
               ...
               if(tenpo4 == "---"){
                  tenpo4 = tenpoQ6;
                  if($gameVariables.value(186) <= 9){
                     tenpo4z =$gameVariables.value(186) + keika1;
                  }
                  if($gameVariables.value(186) == 10){
                     tenpo4z = kyuyo1;
                  }
                  ...
                  if(tenpo5 == "---"){
                     tenpo5 = tenpoQ6;
                     if($gameVariables.value(186) <= 9){
                        tenpo5z =$gameVariables.value(186) + keika1;
                     }
                     if($gameVariables.value(186) == 10){
                        tenpo5z = kyuyo1;
                     }
                     ...
                     tenpo6 = tenpoQ6;
                     if($gameVariables.value(186) <= 9){
                        tenpo6z =$gameVariables.value(186) + keika1;
                     }
                     if($gameVariables.value(186) == 10){
                        tenpo6z = kyuyo1;
                     }
    ...
    //日本語
    if ($gameSwitches.value(115)) {
       this.drawText("現在の状態", x-12, y-74 + lineHeight * 0, 270);
    } else {
       this.drawText("Current state", x-12, y-74 + lineHeight * 0, 270);
    }
    this.changeTextColor(this.textColor(3));
    this.drawText(zyoutai, x+20, y-80 + lineHeight * 1, 270);

    this.resetTextColor();
    this.drawText(tenpo1, x+20, y-88 + lineHeight * 2, 270);
    this.drawText(tenpo2, x+20, y-94 + lineHeight * 3, 270);
    this.drawText(tenpo3, x+20, y-98 + lineHeight * 4, 270);
    this.drawText(tenpo4, x+20, y-100 + lineHeight * 5, 270);
    this.drawText(tenpo5, x+20, y-104 + lineHeight * 6, 270);
    this.drawText(tenpo6, x+20, y-108 + lineHeight * 7, 270);

    if(tenpo1z==heiten1){
       this.changeTextColor(this.textColor(18));
    } else if(tenpo1z==kyuyo1){
       this.changeTextColor(this.textColor(14));
    } else {
       this.resetTextColor();
    }
    this.drawText(tenpo1z, x+254, y-88 + lineHeight * 2, 270);
    if(tenpo2z==heiten1){
       this.changeTextColor(this.textColor(18));
    } else if(tenpo2z==kyuyo1){
       this.changeTextColor(this.textColor(14));
    } else {
       this.resetTextColor();
    }
    this.drawText(tenpo2z, x+254, y-94 + lineHeight * 3, 270);
    if(tenpo3z==heiten1){
       this.changeTextColor(this.textColor(18));
    } else if(tenpo3z==kyuyo1){
       this.changeTextColor(this.textColor(14));
    } else {
       this.resetTextColor();
    }
    this.drawText(tenpo3z, x+254, y-98 + lineHeight * 4, 270);
    if(tenpo4z==heiten1){
       this.changeTextColor(this.textColor(18));
    } else if(tenpo4z==kyuyo1){
       this.changeTextColor(this.textColor(14));
    } else {
       this.resetTextColor();
    }
    this.drawText(tenpo4z, x+254, y-100 + lineHeight * 5, 270);
    if(tenpo5z==heiten1){
       this.changeTextColor(this.textColor(18));
    } else if(tenpo5z==kyuyo1){
       this.changeTextColor(this.textColor(14));
    } else {
       this.resetTextColor();
    }
    this.drawText(tenpo5z, x+254, y-104 + lineHeight * 6, 270);
    if(tenpo6z==heiten1){
       this.changeTextColor(this.textColor(18));
    } else if(tenpo6z==kyuyo1){
       this.changeTextColor(this.textColor(14));
    } else {
       this.resetTextColor();
    }
    this.drawText(tenpo6z, x+254, y-108 + lineHeight * 7, 270);
    ...
    //}
    //this.changeTextColor(this.systemColor());
    //this.drawText(expTotal, x-12, y-104 + lineHeight * 8, 270);
    //this.drawText(expNext, x-12, y-104 + lineHeight * 9, 270);
    //this.resetTextColor();
    //this.drawText(value1, x+10, y-104 + lineHeight * 8, 270, 'right');
    //this.drawText(value2, x+10, y-104 + lineHeight * 9, 270, 'right');
};
