...
$TKMvar.tachie.MaxLayer = 12; // 0~9; このプラグインをカスタマイズする時に、ここを調整
    ...
    Game_Interpreter.prototype.pluginCommand = function (command, args) {
        ...
        switch ((command || '')) {
            ...
            case 'tachie_Draw':             // tachie_Draw [立ち絵番号] [オプション]
                ...
                if(tachieNum == 0) {
                var x = $gameVariables.value(11);
                var y = $gameVariables.value(12);
                var x2 = $gameVariables.value(13);
                var y2 = $gameVariables.value(14);

                } else if(tachieNum == 1) {
                var x = $gameVariables.value(92);
                var y = $gameVariables.value(93);
                var x2 = $gameVariables.value(94);
                var y2 = $gameVariables.value(95);

                } else if(tachieNum == 2) {
                var x = $gameVariables.value(97);
                var y = $gameVariables.value(98);
                var x2 = $gameVariables.value(99);
                var y2 = $gameVariables.value(100);

                } else if(tachieNum == 3) {
                var x = $gameVariables.value(101);
                var y = $gameVariables.value(102);
                var x2 = $gameVariables.value(103);
                var y2 = $gameVariables.value(104);
                ...
                //$gameScreen.showPicture(pictureId, name, 0, $gameVariables.value(11), $gameVariables.value(12), $gameVariables.value(13), $gameVariables.value(14), 255, 0);
                }
                else{
                    switch(args[1].toUpperCase()) {
                        ...
                        case 'INVISIBLE':
                            ...
                            //$gameScreen.showPicture(pictureId, name, 0, $gameVariables.value(11), $gameVariables.value(12), $gameVariables.value(13), $gameVariables.value(14), 0, 0);
                            break;
